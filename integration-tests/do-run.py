...
def run_integration_test():
    ...
    if sys.platform.startswith('win'):
        subprocess.call(['mvn', 'clean', 'install', '--batch-mode'], shell=True, cwd=integration_tests_path)
    else:
        subprocess.call(['mvn', 'clean', 'install', '--batch-mode'], cwd=integration_tests_path)
